  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <FaqSection
          badge="Communication client Casablanca"
          title="Questions fréquentes"
          items={[
          {
                    "q": "Comment automatiser la communication client d'un hôtel à Casablanca ?",
          ...
          },
          {
                    ...
                    "a": "Oui, plus l'espagnol. Il détecte la langue du client et répond dans celle-ci. À Casablanca, où se croisent clientèles locale et internationale, cela évite d'avoir un réceptionniste multilingue disponible en continu."
          },
          {
          ...
          {
                    "q": "Est-ce adapté à hôtels d'affaires, appart-hôtels et résidences Anfa ?",
        ...
        <section style={{ padding: '32px 32px 56px', borderTop: '1px solid var(--glass-border)' }}>
          <div style={{ maxWidth: 1000, margin: '0 auto' }}>
            ...
            <div style={{ fontSize: 14, color: 'var(--text-3)', lineHeight: 2 }}>
              <Link href={'/pms-casablanca' as const} style={{ color: '#f4cf5e', textDecoration: 'none', fontWeight: 600 }}>PMS hôtel Casablanca</Link>
              {' · '}
              <Link href={'/gestion-locative-casablanca' as const} style={{ color: '#f4cf5e', textDecoration: 'none' }}>Gestion hôtelière Casablanca</Link>
              <br />
              Autres villes :{' '}
