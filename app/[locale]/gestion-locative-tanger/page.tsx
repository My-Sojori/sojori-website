  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <FaqSection
          badge="Gestion hôtelière Tanger"
          title="Questions fréquentes"
          items={[
          {
                    "q": "Quel logiciel de gestion hôtelière choisir à Tanger ?",
          ...
          {
                    "q": "Comment organiser le housekeeping et la maintenance à Tanger ?",
          ...
          },
          {
                    ...
                    "a": "Taux d'occupation, prix moyen, revenu par chambre disponible, et surtout la part du direct dans votre mix. Tanger connaît une saisonnalité marquée et une clientèle européenne de proximité : piloter ces indicateurs par canal, et non globalement, change les décisions de tarification."
          },
          {
                    "q": "Sojori convient-il pour hôtels front de mer, résidences Malabata et maisons d’hôtes de la kasbah ?",
        ...
        <section style={{ padding: '32px 32px 56px', borderTop: '1px solid var(--glass-border)' }}>
          <div style={{ maxWidth: 1000, margin: '0 auto' }}>
            ...
            <div style={{ fontSize: 14, color: 'var(--text-3)', lineHeight: 2 }}>
              <Link href={'/pms-tanger' as const} style={{ color: '#f4cf5e', textDecoration: 'none', fontWeight: 600 }}>PMS hôtel Tanger</Link>
              {' · '}
              <Link href={'/conciergerie-tanger' as const} style={{ color: '#f4cf5e', textDecoration: 'none' }}>Conciergerie Tanger</Link>
              <br />
              Autres villes :{' '}
