...
const FAQ = [
  ...
  },
  {
    ...
    "a": "Oui. Elle est collectée avant l'arrivée : le client la remplit depuis WhatsApp avec sa pièce d'identité, dans le cadre du check-in digital. Sojori prépare les données ; la transmission aux autorités reste votre démarche."
  },
  {
