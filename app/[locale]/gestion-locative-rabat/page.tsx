...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/${locale}/gestion-locative-rabat` },
  };
}
  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <FaqSection
          badge="Gestion hôtelière Rabat"
          title="Questions fréquentes"
          items={[
          {
                    "q": "Quel logiciel de gestion hôtelière choisir à Rabat ?",
          ...
          {
                    "q": "Comment organiser le housekeeping et la maintenance à Rabat ?",
          ...
          },
          {
                    ...
                    "a": "Taux d'occupation, prix moyen, revenu par chambre disponible, et surtout la part du direct dans votre mix. Rabat mêle clientèle diplomatique, administrative et touristique : piloter ces indicateurs par canal, et non globalement, change les décisions de tarification."
          },
          {
                    "q": "Sojori convient-il pour hôtels institutionnels, riads de la médina et résidences Agdal ?",
        ...
        <section style={{ padding: '32px 32px 56px', borderTop: '1px solid var(--glass-border)' }}>
          <div style={{ maxWidth: 1000, margin: '0 auto' }}>
            ...
            <div style={{ fontSize: 14, color: 'var(--text-3)', lineHeight: 2 }}>
              ...
              {' · '}
              <Link href={'/conciergerie-rabat' as const} style={{ color: '#f4cf5e', textDecoration: 'none' }}>Conciergerie Rabat</Link>
              <br />
              Autres villes :{' '}
