...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/${locale}/gestion-locative-casablanca` },
  };
}
        ...
        <section style={{ padding: '32px 32px 56px', borderTop: '1px solid var(--glass-border)' }}>
          <div style={{ maxWidth: 1000, margin: '0 auto' }}>
            ...
            <div style={{ fontSize: 14, color: 'var(--text-3)', lineHeight: 2 }}>
              ...
              {' · '}
              <Link href={'/conciergerie-casablanca' as const} style={{ color: '#f4cf5e', textDecoration: 'none' }}>Conciergerie Casablanca</Link>
              <br />
              Autres villes :{' '}
