...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/${locale}/gestion-locative-marrakech` },
  };
}
  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <FaqSection
          badge="Gestion hôtelière Marrakech"
          title="Questions fréquentes"
          items={[
          {
                    "q": "Quel logiciel de gestion hôtelière choisir à Marrakech ?",
          ...
          {
                    "q": "Comment organiser le housekeeping et la maintenance à Marrakech ?",
          ...
          },
          {
                    ...
                    "a": "Taux d'occupation, prix moyen, revenu par chambre disponible, et surtout la part du direct dans votre mix. Marrakech concentre la plus forte densité d'établissements indépendants du Maroc : piloter ces indicateurs par canal, et non globalement, change les décisions de tarification."
          },
          {
                    "q": "Sojori convient-il pour hôtels de charme, riads de la médina et villas de la Palmeraie ?",
