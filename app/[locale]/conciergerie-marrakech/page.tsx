...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: t('conciergerieMarrakech.title'),
    description: t('conciergerieMarrakech.description'),
    alternates: { canonical: `/${locale}/conciergerie-marrakech` },
  };
}
          ...
          <div style={{ maxWidth: 1000, margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 12 }}>
              {[
                ...
                { step: '5', moment: 'Jour check-out', action: 'Feedback automatique', detail: 'Message remerciement + demande review Booking/Airbnb. Lien direct, taux conversion élevé. Satisfaction mesurée automatiquement.' },
              ].map((c) => (
