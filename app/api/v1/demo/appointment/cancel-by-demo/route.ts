...
/**
 * POST /api/v1/demo/appointment/cancel-by-demo — proxy public → srv-crm.
 */
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const response = await demoProxyFetch(`${backendBase}/api/v1/demo/appointment/cancel-by-demo`, {
      method: 'POST',
    ...
    console.error('Error proxying cancel-by-demo:', error);
