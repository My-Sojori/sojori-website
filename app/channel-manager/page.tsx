    ...
    <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
      ...
      <div style={{ padding: '8px 0' }}>
        {[
          ...
          <div key={i} style={{ display: 'grid', gridTemplateColumns: '32px 1fr 100px 100px 100px 80px', gap: 14, alignItems: 'center', padding: '11px 18px', borderTop: i ? '1px solid rgba(255,255,255,0.04)' : 'none' }}>
  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <FinalCTA title={<>Connectez vos OTAs. <span className="gradient-text">En 5 min.</span></>} subtitle="Setup guidé. Migration depuis votre channel manager actuel offerte. 14 jours d'essai." />
        <PageFooter />
      </div>
    </>
  );
