...
export const metadata: Metadata = generateSEO({
  title: 'Gestion Locative Marrakech | Logiciel Property Management Riads & Villas',
  description: 'Solution complète gestion locative saisonnière à Marrakech. PMS + Channel Manager + Conciergerie 24/7 pour riads, villas, appartements. Synchronisation Airbnb, Booking.com, tarification dynamique, WhatsApp AI.',
  keywords: [
    ...moroccanKeywords,
    ...frenchKeywords,
    'gestion locative Marrakech',
    'property management Marrakech',
    'logiciel location riad Marrakech',
    'gestion villa Marrakech',
    'automatisation location Maroc',
    'PMS complet Marrakech',
    'channel manager Marrakech',
    'conciergerie automatique Marrakech',
  ],
  path: '/gestion-locative-marrakech',
});
